  ...
  return (
    <div>
      ...
      <div className='flex flex-col lg:flex-row gap-10 px-2 lg:p-10 justify-center items-center'>
        <Image data-aos="fade-up" src="/images/party.jpg" width={1000} height={1000} className='lg:w-1/2 h-1/3 rounded px-5' />
