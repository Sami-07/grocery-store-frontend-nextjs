...
export default function About() {
  return (
    <div>
      <div className='flex-col lg:mt-10 flex lg:items-center lg:flex-row-reverse lg:justify-center lg:gap-10 mt-20 lg:px-10'>
        <div>
      ...
      <div className='flex justify-between flex-col items-center lg:gap-5 lg:w-3/4 mt-10 m-auto lg:flex-row'>
        ...
        <p className='lg:w-1/2 mt-10 text-lg px-5' data-aos="fade-up">At <strong style={{ color: "#FF4081" }}>Qidmat Kirana Store</strong>, we believe that convenience should be a part of your shopping experience. That is why we offer a hassle-free home delivery service on orders above 1000 rupees, right to your doorstep. No more lugging heavy grocery bags or waiting in long queues—just sit back, relax, and let us bring the goodness to you.</p>
      </div>
      ...
      <h1 data-aos="fade-up" className='gradient-text text-4xl text-center mt-16 mb-5 px-5' >We Undertake all kinds of Party Orders</h1>
