...
export default function Home() {
  return (
    <main>
      ...
      <Image src="/images/mobile home bg.jpg" data-aos="fade-up" width={2000} height={1000} className='md:hidden w-full h-1/3 mt-16 lg:w-full' />
      <div className='lg:absolute md:top-0 lg:top-1/4 2xl:top-1/2 lg:ml-14'>
        <h1 data-aos="fade-up" className='text-3xl  text-center lg:text-5xl mt-3 lg:w-5/12 gradient-text md:px-5 md:w-full' >Qidmat Kirana & General Store Wholesale & Retail </h1>
